    ...
    var body: some View{
        VStack (){
            ...
            VStack (alignment: .leading, spacing: 0){
                Text("Profile").font(.system(size: 22)).bold()
            ...
            VStack(spacing: 03){
                Image("carbon_user-avatar-filled-alt").resizable().scaledToFit()
                    ...
                    .padding(EdgeInsets(top: 0, leading: 0, bottom:07, trailing: 0))
                    ...
                    VStack{
                        ZStack {
                            Circle()
                                ...
                                .rotationEffect(.degrees(-90))
                                .overlay(
                                    Text("\(Int(progressB * 100.0))%")).font(.system(size: 12))
